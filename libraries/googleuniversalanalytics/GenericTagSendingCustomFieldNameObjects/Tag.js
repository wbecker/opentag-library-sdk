...
qubit.qtag.LibraryTag.define("googleuniversalanalytics.GenericTagSendingCustomFieldNameObjects", {
    config: {/*DATA*/
	id: 36171,
...
ga('create', '' + this.getValueForToken("web_property_id") + '');

for (var i=0; i < this.getValueForToken("field_objects").length; i++){
  ga('send', this.getValueForToken("field_objects")[i]);
}
