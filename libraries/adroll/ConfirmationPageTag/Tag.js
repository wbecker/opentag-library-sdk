...
qubit.qtag.LibraryTag.define("adroll.ConfirmationPageTag", {
    config: {/*DATA*/
	id: 34673,
...
window.adroll_conversion_value_in_dollars = this.getValueForToken("total");
window.adroll_custom_data = {
  "ORDER_ID": "" + this.getValueForToken("order_id") + "", 
  "USER_ID": "" + this.getValueForToken("user_id") + ""
};
