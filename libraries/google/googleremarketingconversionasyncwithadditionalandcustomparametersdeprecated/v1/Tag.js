...
qubit.opentag.LibraryTag.define(
	"google.googleremarketingconversionasyncwithadditionalandcustomparametersdeprecated.v1.Tag", {
		getDefaultConfig: function () {
      return {
			/*DATA*/
			name: "Google Remarketing Conversion Async, with additional and custom parameters [DEPRECATED]",
			async: true,
