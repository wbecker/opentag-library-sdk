...
qubit.opentag.Utils.namespace('google.googleadwordswithadditionalparametersdeprecated.local');
google.googleadwordswithadditionalparametersdeprecated.local.Config =  {
  "parameters": [
     {
      "name": "Conversion ID",
      "description": "",
