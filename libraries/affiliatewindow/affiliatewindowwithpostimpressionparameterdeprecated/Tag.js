...
qubit.opentag.LibraryTag.define("affiliatewindow.affiliatewindowwithpostimpressionparameterdeprecated.Tag", {
	config: {
		/*DATA*/
...
(function () {
    ...
    var awinImgSrc = [
        ...
        "&pv=" + this.valueForToken("isPostImpression") + ""     
    ].join("");
    ...
    window.AWIN = {
      Tracking: {
        Sale: {
          ...
          pvOnly: "" + this.valueForToken("isPostImpression") + ""
        }
      }
    };
