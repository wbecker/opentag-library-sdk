...
function pcto_dis() {
  if (document.createElement) {
    ...
    if (cto_dis_im) {
      ...
      var cto_dis_im_src = '//dis.criteo.com/dis/dis.aspx?p=' + this.valueForToken("partner_id") + '&c=2&cb='
...
_cr_i.src = domain + "/" + this.valueForToken("call_parameter") + "/display.js?p1=" + escape('v=2&wi=' + this.valueForToken("wi") + '&pt1=0&pt2=1') + "&t1=sendEvent&resptype=gif&cb=" + Math.floor(Math.random() * 99999999999);
