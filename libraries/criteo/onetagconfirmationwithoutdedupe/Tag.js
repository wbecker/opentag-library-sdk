...
qubit.opentag.LibraryTag.define("criteo.onetagconfirmationwithoutdedupe.Tag", {
	config: {
		/*DATA*/
...
(function() {
  ...
  window.criteo_q.push(
    ...
    { event: "trackTransaction", id: "" + this.valueForToken("order_id") + "", new_customer: ret, product: products }
  );
