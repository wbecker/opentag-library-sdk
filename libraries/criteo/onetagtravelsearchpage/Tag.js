...
(function() {
  ...
  window.criteo_q.push(
    ...
    { event: "viewList", product: products, keywords: "" + this.valueForToken("search_query") + "" },
    //Criteo informs me that this style of tag is only really necessary for travel clients.
    { event: "viewSearch", checkin_date: "" + this.valueForToken("check_in") + "", checkout_date: "" + this.valueForToken("check_out") + "" }
  );
