...
qubit.opentag.LibraryTag.define("criteo.legacyproductpagetag.Tag", {
	config: {
		/*DATA*/
...
_cr_i.src = domain + "/" + this.valueForToken("call_parameter") + "/display.js?p1=" + escape("v=2&wi=" + this.valueForToken("wi") + "&pt1=2&i=" + this.valueForToken("product_id") + "") + "&t1=sendEvent&resptype=gif&cb=" + Math.floor(Math.random() * 99999999999);
