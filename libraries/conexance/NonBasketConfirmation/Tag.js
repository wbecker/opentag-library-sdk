...
qubit.qtag.LibraryTag.define("conexance.NonBasketConfirmation", {
    config: {/*DATA*/
	id: 34660,
...
(function() {
  ...
  require("" + this.getValueForToken("web1by1_functions_script") + "", function() {
    require("" + this.getValueForToken("web1by1_config_script") + "", function() {
      window.w1x1.iSet(this.getValueForToken("tag_type"), "" + this.getValueForToken("value") + "");
    });
  });
