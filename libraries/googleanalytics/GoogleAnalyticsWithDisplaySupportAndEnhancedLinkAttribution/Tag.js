...
qubit.qtag.LibraryTag.define("googleanalytics.GoogleAnalyticsWithDisplaySupportAndEnhancedLinkAttribution", {
    config: {/*DATA*/
	id: 39679,
...
_gaq.push(['_setAccount', '' + this.getValueForToken("google_id") + '']);
