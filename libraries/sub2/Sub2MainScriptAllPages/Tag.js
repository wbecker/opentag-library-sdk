...
qubit.qtag.LibraryTag.define("sub2.Sub2MainScriptAllPages", {
    config: {/*DATA*/
	id: 39674,
  ...
  var _SUB2metadata = {
    clientid: "" + this.getValueForToken("client_id") + "", 
    clientname: "" + this.getValueForToken("client_name") + "", 
    serviceversion: "v12.0",
    cookiedomain: "" + this.getValueForToken("cookie_domain") + "",
    callingdomain: "",
    newsletter: "",
    login: "",
    applynow: "",
  ...
  function S2Tech_addItem(o, s, n, c, p, q)
  {
    ...
    SUB2_queue.push(["S2Tech_addItem", o, s, n, c, p, q]);
  }
