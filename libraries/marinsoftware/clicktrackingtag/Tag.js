...
qubit.qtag.LibraryTag.define("marinsoftware.clicktrackingtag.Tag", {
	config: {
		/*DATA*/
...
var shouldAnonymizeIP = "" + this.getValueForToken("anonymize_ip") + "";
...
(function() 
{
   var mClientId ="" + this.getValueForToken("marin_tracking_id") + "";
