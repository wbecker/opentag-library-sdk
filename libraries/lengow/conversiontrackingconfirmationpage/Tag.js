...
var version = "";
var classPath = "lengow.conversiontrackingconfirmationpage" + version;
...
qubit.opentag.LibraryTag.define(classPath + ".Tag", {
	config: {
		...
		html: "<!--@SRC@--><script type=\"text/javascript\">\n(function(){\nvar lengowTrackPixel = new Image();\n\nlengowTrackPixel.src = \"https://tracking.lengow.com/leadValidation.php?idClient=${lengow_customer_id}&idGroup=${lengow_group_id}&price=${lengow_order_value}&idCommande=${lengow_order_id}\";\nlengowTrackPixel.alt= \"\";\n})();\n</script>",
