...
qubit.qtag.LibraryTag.define("radiumone.RadiumOneConfirmationPagesDEPRECATED", {
    config: {/*DATA*/
	id: 30165,
  ...
  iframe.src = '//rs.gwallet.com/r1/pixel/x6034r'+time+'?product_quantity='+product_qty_list;
  iframe.width = 1;
  iframe.height = 1;
