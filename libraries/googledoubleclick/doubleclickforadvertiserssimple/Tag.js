...
qubit.opentag.LibraryTag.define("googledoubleclick.doubleclickforadvertiserssimple.Tag", {
	config: {
		/*DATA*/
...
fl_if.src='//' + this.valueForToken("doubleclick_id") + '.fls.doubleclick.net/activityi;src=' + this.valueForToken("doubleclick_id") + ';type=' + this.valueForToken("type") + ';cat=' + this.valueForToken("cat") + ';ord=1;num=' + a + '?';
fl_if.width="1";
fl_if.height="1";
fl_if.frameborder="0";
