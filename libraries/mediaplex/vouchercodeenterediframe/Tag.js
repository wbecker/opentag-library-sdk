...
(function(){
  ...
  src = src + "img-cdn.mediaplex.com/0/" + this.valueForToken("client_id") + "/universal.html?page_name=" + this.valueForToken("page_name") + "&" + this.valueForToken("event_name") + "=1&PromoCode=" + this.valueForToken("promo_code") + "&mpuid=";
  frame.src = src;
  frame.height = 1;
  frame.width = 1;
  frame.frameborder = 0;
