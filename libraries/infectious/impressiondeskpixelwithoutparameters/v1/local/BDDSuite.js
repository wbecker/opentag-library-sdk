...
var suite = describe("firing a tag", function() {
  ...
  beforeEach(function() {
    tag = new infectious.impressiondeskpixelwithoutparameters.v1.Tag({
...
qubit.opentag.Utils.namespace('infectious.impressiondeskpixelwithoutparameters.v1.local.BDDSuite', suite);
