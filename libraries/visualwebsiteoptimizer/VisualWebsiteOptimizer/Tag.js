...
qubit.qtag.LibraryTag.define("visualwebsiteoptimizer.VisualWebsiteOptimizer", {
    config: {/*DATA*/
	id: 36666,
...
var _vwo_code=(function(){
  var account_id=this.getValueForToken("accountid"),
    settings_tolerance=this.getValueForToken("settings_tolerance"),
      library_tolerance=this.getValueForToken("library_tolerance"),
        use_existing_jquery=this.getValueForToken("use_jquery"),
