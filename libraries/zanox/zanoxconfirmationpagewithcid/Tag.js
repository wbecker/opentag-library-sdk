...
qubit.opentag.LibraryTag.define("zanox.zanoxconfirmationpagewithcid.Tag", {
	config: {
		/*DATA*/
...
(function() {
    ...
    window._zx.push({"id":"" + this.valueForToken("zanox_page_id") + ""});
    var waitForZanoxDiv = function ()
    {
      if (document.querySelector(".zx_" + this.valueForToken("zanox_page_id") + ".zx_mediaslot"))
      {
        (function(d)
        {
