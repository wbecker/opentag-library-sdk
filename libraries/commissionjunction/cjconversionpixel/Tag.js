...
(function() {
  var url = "https://www.emjcd.com/tags/c?containerTagId=" + this.getValueForToken("containerid") + "&";
  for (var i = 0, ii = this.getValueForToken("item_ids").length; i < ii; i++) {
    url = url + "ITEM" + (i+1) + "=" + this.getValueForToken("item_skus")[i] + "&AMT" + (i+1) + "=" + this.getValueForToken("item_prices")[i] + "&QTY" + (i+1) + "=" + this.getValueForToken("item_quantites")[i] + "&";
  }
  url = url + "CID=" + this.getValueForToken("cid") + "&OID=" + this.getValueForToken("orderid") + "&TYPE=" + this.getValueForToken("actionid") + "&CURRENCY=" + this.getValueForToken("currency") + "";
