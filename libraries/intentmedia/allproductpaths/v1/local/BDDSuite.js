...
//:include intentmedia/allproductpaths/v1/Tag.js
...
var suite = describe("firing a tag", function() {
  ...
  beforeEach(function() {
    tag = new intentmedia.allproductpaths.v1.Tag({
...
qubit.opentag.Utils.namespace('intentmedia.allproductpaths.v1.local.BDDSuite', suite);
