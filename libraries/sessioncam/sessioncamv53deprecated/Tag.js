...
var version = "";
var classPath = "sessioncam.sessioncamv53deprecated.Tag";
...
qubit.opentag.LibraryTag.define(classPath + version, {
	...
	script: function() {
		...
		var ServiceTickDetection = function() {
			...
			var removeServiceTickFlash = function(swfobject) {
				try {
					var container = document.getElementById('stflashobContainer');
					if (container) {
			...
			var addServiceTickCode = function() {
				var rec, headID, scriptBaseURL, newScript;
				rec = document.createElement('script');
				rec.type = 'text/javascript';
				rec.src = recorder;
				document.getElementsByTagName('head')[0].appendChild(rec);
			};
			var addServiceTickFlash = function() {
				...
				stflashobContainer.setAttribute('style', 'width:1;height:1;display:inline;');
