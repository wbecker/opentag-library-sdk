...
(function () {
  ...
  Utils.defineClass = function (config, classPath, extendingClass) {
    ...
    console.log("PETER, PLEASE: MAKE SURE INSTANCE OF WORKS AND NAME IS SET SAME LIKE ON PTP!!!");
//MAKE SURE INSTANCE OF WORKS AND NAME IS SET SAME LIKE ON PTP!!!
...
(function () {
  ...
  LibraryTag.define = function (namespace, config) {
    return qubit.qtag.Utils.defineClass(config, namespace, LibraryTag);
  };
